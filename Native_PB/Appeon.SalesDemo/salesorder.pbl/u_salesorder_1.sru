forward
global type u_salesorder_1 from u_salesorder
end type
end forward

global type u_salesorder_1 from u_salesorder
end type
global u_salesorder_1 u_salesorder_1

on u_salesorder_1.create
call super::create
end on

on u_salesorder_1.destroy
call super::destroy
end on

type tab_1 from u_salesorder`tab_1 within u_salesorder_1
end type
...
type cb_add from u_salesorder`cb_add within u_salesorder_1
end type

type cb_delete from u_salesorder`cb_delete within u_salesorder_1
end type

type cb_save from u_salesorder`cb_save within u_salesorder_1
end type
